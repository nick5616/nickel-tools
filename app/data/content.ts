...
export type Status = 'operational' | 'in-development' | 'experimental' | 'archived';
  ...
  content: [
    {
      ...
      description: 'Immersive first-person art and software engineering portfolio, with interactive games and experiences thrown in for fun. Built in Three.js.',
    ...
    },
    {
      ...
      description: 'A pokédex for your friends. Built for Mobile. Prototyped on Web.',
    ...
    },
    {
      ...
      description: 'Convert journal entries into video game quests, and live your life like an RPG.',
    ...
    },
    {
      ...
      description: 'Rank anything, optimized for your phone. I built it because I thought the Tiermaker mobile site could use some improvement.',
    ...
    },
    {
      ...
      description: 'Algorithmic palette generator based on harmonic color theory.',
    ...
    },
    {
      ...
      type: 'external',
      title: 'Passionfruit',
      description: 'Conveniently track and understand all the projects you are working on',
    ...
    },
    {
      ...
      type: 'internal',
      title: 'Smart Piano',
      description: 'An online piano that uses the key you\'re in and the musical context to suggest the next notes to play',
    ...
    },
    {
      ...
      type: 'external',
      title: 'saucedog.art',
      description: 'My art portfolio from 2022-2023. A collection of digital art, illustrations, and creative projects.',
    ...
    },
    {
      ...
      description: 'A series of games designed to improve mental math, working memory, creativity, etc',
      thumbnail: '/project-screenshots/latex.png', // Placeholder
    ...
    },
    {
      ...
      type: 'external',
      title: 'CHAOS',
      description: 'Counter-Strike Highlight Analysis and Organization System. A tool that batch processes video game footage and filters noteworthy in-game moments using machine learning (OCR, Speech-To-Text) (Desktop app on hiatus).',
